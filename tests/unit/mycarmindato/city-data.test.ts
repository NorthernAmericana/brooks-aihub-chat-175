 ...
 * - Verifying Season 1 cities are present
 */
...
async function runTests() {
  ...
  console.assert(cities.length >= 216, `Should have at least 216 entries, got ${cities.length}`);
  ...
  console.log("✓ Test 2 passed - All 17 Season 1 cities present (17/200 capacity)");
