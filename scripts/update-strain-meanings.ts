...
async function updateStrainFiles() {
  ...
  for (const file of files) {
    ...
    try {
      ...
      console.log(`     - Aroma/flavor tags: ${updatedStrain.meaning.aroma_flavor_tags.length}`);
      console.log(`     - Effect tags: ${updatedStrain.meaning.effect_tags.length}`);
      console.log(`     - Dominant terpenes: ${updatedStrain.meaning.dominant_terpenes.length}`);
      console.log(`     - Minor cannabinoids: ${updatedStrain.meaning.minor_cannabinoids_present.length}\n`);
...
updateStrainFiles().catch(console.error);
