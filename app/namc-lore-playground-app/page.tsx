...
const APP_SLUG = "namc-lore-playground";
...
export default async function NamcLorePlaygroundAppPage() {
  ...
  const installAction = async () => {
    ...
    revalidatePath("/namc-lore-playground-app");
  };
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-16 w-16 items-center justify-center overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
                <ImageWithFallback
                  alt={`${app?.name ?? "NAMC Lore Playground"} icon`}
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">
                  Media & Entertainment • Founders-only
                </p>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
          ...
          <div className="mt-5 space-y-4 text-sm text-slate-600">
            <div>
              ...
              <p className="mt-1">
                NAMC Lore Playground is the dedicated lore sandbox for Northern Americana
                Media Collection worlds and external media universes. Use it to
                map timelines, compare canon facts, test theories, and pressure
                test headcanons with continuity checks.
              </p>
            </div>
            <div>
              ...
              <div className="mt-2 space-y-2 text-sm text-slate-600">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-slate-500">
                    Dedicated lore route for canon analysis, theories,
                    spoiler-aware summaries, and worldbuilding prompts
                  </span>
                </div>
