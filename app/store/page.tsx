  ...
  const apps = [
    {
      ...
      name: "BrooksBears",
      path: "/BrooksBears/",
      description: "Companion app for bear-themed AI interactions",
      icon: "🐻",
    ...
    },
    {
      ...
      name: "MyCarMindATO",
      path: "/MyCarMindATO/",
      description: "Your intelligent automotive assistant",
      icon: "🚗",
      category: "Utilities",
      rating: 4.7,
      downloads: "5K+",
    },
    {
      ...
      name: "MyFlowerAI",
      path: "/MyFlowerAI/",
      description: "AI-powered plant care and identification",
      icon: "🌸",
      category: "Lifestyle",
      rating: 4.8,
      downloads: "15K+",
