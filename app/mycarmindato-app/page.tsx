...
const screenshots: ScreenshotData[] = [
  {
    src: "/store-screenshots/mycarmindato/cover.svg",
    alt: "MyCarMind ATO app home screen with primary actions and overview cards.",
    caption: "Home overview",
  },
  {
    src: "/store-screenshots/mycarmindato/workflow.svg",
    alt: "MyCarMind ATO workflow screen showing progress, guidance, and tools.",
    caption: "Workflow view",
  },
  {
    src: "/store-screenshots/mycarmindato/results.svg",
    alt: "MyCarMind ATO results screen with generated insights and completion summary.",
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Utilities • 13+</p>
