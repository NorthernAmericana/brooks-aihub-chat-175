...
const screenshots: ScreenshotData[] = [
  {
    src: "/store-screenshots/namc/cover.svg",
    alt: "NAMC app home screen with primary actions and overview cards.",
    caption: "Home overview",
  },
  {
    src: "/store-screenshots/namc/workflow.svg",
    alt: "NAMC workflow screen showing progress, guidance, and tools.",
    caption: "Workflow view",
  },
  {
    src: "/store-screenshots/namc/results.svg",
    alt: "NAMC results screen with generated insights and completion summary.",
          ...
          <div className="mt-5 space-y-4 text-sm text-slate-600">
            ...
            <div>
              ...
              <div className="mt-2 space-y-3 text-sm text-slate-600">
                <p>
                  NAMC has agentic chat subroutes in Brooks AI HUB for
                  specialized assistance. The main /NAMC/ route will suggest
                  Lore Playground when users want lore or headcanon help for any
                  media.
                </p>
                <div className="space-y-3">
                  <Link
                    className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 transition hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-slate-300"
                    href="/NAMC/reader"
                  >
                    <div>
                  ...
                  >
                    <div>
                      ...
                      <div className="mt-0.5 text-xs text-slate-500">
                        Explore NAMC lore + external media lore, headcanon
                        support, and spoiler-aware discussions
                      </div>
                      <div className="mt-1 text-[11px] font-medium text-slate-600">
